...
std::string toString(OrderType orderType_) {
    switch (orderType_) {
        ...
        case OrderType_IOC:
            return "OrderType_IOC";
        case OrderType_SPREAD:
            return "OrderType_SPREAD";
    }
    return __FUNCTION__;
}
...
std::string toString(StrategyStatus status_) {
    switch (status_) {
        ...
        case StrategyStatus_TERMINATED:
            return "StrategyStatus_TERMINATED";
        case StrategyStatus_WAITING:
            return "StrategyStatus_WAITING";
        case StrategyStatus_DISCONNECTED:
            return "StrategyStatus_DISCONNECTED";
    }
    return __FUNCTION__;
}
std::string toString(OrderStatus status_) {
    switch (status_) {
        ...
        case OrderStatus_ADAPTOR_REJECT:
            return "OrderStatus_ADAPTOR_REJECT";
    }
    return __FUNCTION__;
}
std::string toString(OrderRequest request_) {
    switch (request_) {
        ...
        case OrderRequest_NEW:
            return "OrderRequest_NEW";
        case OrderRequest_MODIFY:
            return "OrderRequest_MODIFY";
        case OrderRequest_CANCEL:
            return "OrderRequest_CANCEL";
        case OrderRequest_IOC:
            return "OrderRequest_IOC";
        case OrderRequest_CANCEL_ALL:
            return "OrderRequest_CANCEL_ALL";
    }
    return __FUNCTION__;
}
}// namespace Lancelot::API
